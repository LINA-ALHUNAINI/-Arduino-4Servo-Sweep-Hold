...
- (optional) circuit screenshot from Tinkercad
...
*يُضاف هنا فيديو المحاكاة أو مقطع GIF قصير قبل التسليم، على سبيل المثال:*
`![demo](demo.gif)` *أو رابط فيديو مباشر.*
يمكن أيضًا إضافة لقطة شاشة (Screenshot) للدارة من Tinkercad كمرجع ثابت.
...
- (اختياري) صورة من الدارة على Tinkercad